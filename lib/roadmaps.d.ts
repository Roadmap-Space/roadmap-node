...
export declare class Roadmaps extends Model {
    ...
    getItems(roadmapId: string, type: string, cb: (err: any, result?: Array<IItem>) => void): void;
    getCompleted(roadmapId: string, cb: (err: any, result?: Array<IItem>) => void): void;
    update(data: IRoadmap, cb: (err: any, rm?: IRoadmap) => void): void;
    getGithubRepos(id: string, cb: (err: any, result?: Array<IKeyValue>) => void): void;
    ...
    setMeta(roadmapId: string, metaDataType: number, values: Array<string>, cb: (err: any, results?: Array<string>) => void): void;
