...
export declare class Stories extends Model {
    ...
    list(id: string, cb: (err: any, results?: IItem[]) => void): void;
    done(id: string, cb: (err: any, results?: IItem[]) => void): void;
    ...
    reOrder(roadmapId: string, items: IItem[], cb: (err: any, result?: number) => void): void;
