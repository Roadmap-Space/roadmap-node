...
export declare class Items extends Model {
    ...
    getByType(roadmapId: string, isStory: boolean, cb: (err: any, result?: Array<IItem>) => void): void;
    ...
    getEngagements(params: IItemEngagementsParams, cb: (err: any, results?: Array<IItemEngagement>) => void): void;
