...
export class Roadmaps extends Model {
  ...
  all(cb: (err: any, result?: IRoadmap[]) => void) {
    this.get(
      '/roadmaps',
      (result: IRoadmap[]) => {
        cb(null, result);
  ...
  summary(cb: (err: any, result?: IRoadmap[]) => void) {
    this.get(
      '/roadmaps/summary',
      (result: IRoadmap[]) => {
        cb(null, result);
  ...
  getGithubRepos(
    id: string,
    cb: (err: any, result?: IKeyValue[]) => void,
  ) {
    this.get(
  ...
  setMeta(
    ...
    metaDataType: number,
    values: string[],
    cb: (err: any, results?: string[]) => void,
  ) {
    this.put(
      '/roadmaps/' + roadmapId + '/meta',
      { roadmapId, metaDataType, values },
      (results: string[]) => {
        cb(null, results);
      },
      (err: any, statusCode?: number) => {
